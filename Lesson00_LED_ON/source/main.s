...
* 0x00040000 = 1 left shifted 18 times
*
* then
* r1=0x00010000	a number with bit 16 high, so we can communicate with GPIO 16.
* 0x00010000 = 1 left shifted 16 times
*/

// Create a number
// 0x00040000 = 1 left shifted 18 times
// a 1 shifted left 18 times creates the number 0x40000
mov r1, #1
lsl r1, #18
...
/*
* Create a number.
* This number is used to control the GPIO 16 that is connected to the LED
*
